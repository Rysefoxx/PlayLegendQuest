...
class QuestDisplayNameOperationTest {
    ...
    @Test
    public void questUpdatedLongDisplayName() throws InterruptedException {
        ...
        this.player.performCommand("quest update displayname " + questName + " das ist eine unfassbare langer displayname");
    ...
    @Test
    public void questUpdatedShortDisplayName() throws InterruptedException {
        String questName = UUID.randomUUID().toString().replace("-", "");
        this.player.performCommand("quest create " + questName);
