...
class QuestDeleteOperationTest {
    ...
    @Test
    public void deleteQuest() throws InterruptedException {
        ...
        this.player.performCommand("quest delete " + questName);

        //Sehr dumm! Aber da alles Async läuft, müssen wir warten, bis der Command ausgeführt wurde.
        Thread.sleep(5000);

        this.player.assertSaid("The quest has been successfully deleted.");
    }
